...
class PostManMailerService
{
    ...
    public function sendEmailTemplate($emailService , $receiver , $options): bool
    {
        ...
        $variableMappings = [
            ...
            'ticket_created_at' => $options ? $options['ticket'] ? $options['ticket']->getTicketGeneratedAt()->format('d/m/Y') :'' :'' ,
            'ticket_printed_at' => $options ? $options['ticket'] ? $options['ticket']->getTicketPrintedAt()->format('d/m/Y') :'' :'' ,
            'ticket_confirmed_at' => $options ? $options['ticket'] ? $options['ticket']->getUpdatedAt()->format('d/m/Y') :'' :'' ,
            ...
            'wheel_of_fortune_link' => 'getWheelOfFortuneParticipationLink',
