...
import PersonalInformations
    from "@/pages/dashboard/dashboardComponents/GeneralSettingsComponents/components/PersonalInformations";


import SecuritySettings
    from "@/pages/dashboard/dashboardComponents/GeneralSettingsComponents/components/SecuritySettings";
